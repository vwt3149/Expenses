...
<?php
  ...
  if(isset($_POST['btn_login'])){
      ...
      $server_pass = "";
      $base = "budget_app";
      $sql = "SELECT * FROM users WHERE email='".$email."' AND _password='".$password."'";
                ...
                ;
                 if($row['_password'] === $password){
                  ...
                  echo '<div class="alert alert-danger">
                    <strong>Error message:</strong> Wrong email or password.
                    </div>';
                }
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <form class="user" action="login.php" method="POST">
                    ...
                    <input type="submit" name="btn_login" value="login"class="btn btn-primary btn-user btn-block">
                    <hr>
